...
DB_NAME=$(cat /project/secrets/db_creds | grep DB_NAME | cut -d '=' -f2 | tr -d '\n')
DB_USER=$(cat /project/secrets/db_creds | grep DB_USER | cut -d '=' -f2 | tr -d '\n')
DB_PASS=$(cat /project/secrets/db_creds | grep DB_PASS | cut -d '=' -f2 | tr -d '\n')
DB_ROOT=$(cat /project/secrets/db_root | tr -d '\n')
